...
<p>Nous avons trouvé <? echo $nb_resultats; //nombre de résultats 
...
<p>Nous n'avons trouvé aucun résultat pour votre requête "<? echo $_POST['requete']; ?>". <a href="rechercher.php">Réessayez</a> avec d'autres mots clés.</p>
<?
}
mysql_close(); 
}
